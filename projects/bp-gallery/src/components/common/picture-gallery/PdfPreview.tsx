...
const PdfPreview = ({ picture, onClick, adornments, allowClicks = true }: PdfPreviewProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Document className={`flex ${loading ? 'hidden' : ''}`} file={asUploadPath(picture.media)}>
          <Thumbnail pageIndex={0} onLoadSuccess={page => setPage(page)} canvasRef={canvasRef} />
        </Document>
