...
const PictureStats = ({ picture, hovered }: PictureStatsProps) => {
  ...
  return showStats ? (
    <div
      ...
      className='absolute flex w-full h-full justify-end bottom-0 transparent right-0 text-white brightness-100'
    >
      <div className={`h-8 w-full mt-auto bg-gradient-to-t from-neutral-900`}></div>
      <div
